...
This project is a gathering of all the code using to perform a simuated helicopter flight using Arduino controllers.
...
## VersioningThis README is a work in progress!
...
* **Emily** - *Initial work* - [PurpleBooth](https://github.com/PurpleBooth)
