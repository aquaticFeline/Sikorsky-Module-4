// an uneditted code that maybe could be used? I modified this but I forgot where I put the modified code.
// The modified code removed triangle square cross and circle pins, maybe a couple other things
